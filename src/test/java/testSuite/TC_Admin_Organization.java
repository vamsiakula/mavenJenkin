...
public class TC_Admin_Organization extends CommonActions {
    ...
    public void updatingGeneralInformation() throws IOException, InterruptedException {
        ...
        Organization_General_Information_page organization_general_information_page = new Organization_General_Information_page(driver);
        ...
        organization_general_information_page.verifySectionPage(section1);
        organization_general_information_page.clickEdit();
        organization_general_information_page.updateDetails(new_data1, input_for_new_data1);
        organization_general_information_page.clickSave();
        driver.navigate().refresh();
        organization_general_information_page.validateUpdatedInformation(new_data1, input_for_new_data1);
    }
   ...
   // @Test
    public void validateCountOfEmployees() throws InterruptedException, IOException {
        ...
        commonPage.selectSectionOfAdmin(module_name1, sub_module_name1_of_module_name1, section1);
        organization_general_information_page.verifySectionPage(section1);
        int Before_Count=organization_general_information_page.validateCountOfEmployees();
        commonPage.selectSectionOfPIM(module_name2,sub_module_name1_of_module_name2);
        pim_employee_list_page.addingNewEmployee();
        commonPage.selectSectionOfAdmin(module_name1,sub_module_name1_of_module_name1,section1);
        int After_Count=organization_general_information_page.validateCountOfEmployees();
  ...
  // @Test
    public void validateMandatoryFields() throws IOException, InterruptedException {
        ...
        organization_general_information_page.verifySectionPage(section1);
        organization_general_information_page.clickEdit();
        organization_general_information_page.updateDetails(new_data2,input_for_new_data2);
        organization_general_information_page.clickSave();
        organization_general_information_page.validationError();
  ...
  // @Test
    public void validateNonMandatoryFields() throws InterruptedException, IOException {
        ...
        organization_general_information_page.verifySectionPage(section1);
        organization_general_information_page.clickEdit();
        organization_general_information_page.updateDetails(new_data3,input_for_new_data3);
        organization_general_information_page.clickSave();
        driver.navigate().refresh();
        organization_general_information_page.validateUpdatedInformation(new_data3,input_for_new_data3);
    }
    //@Test
    public void validateSearchByAvailableLocationName() throws InterruptedException, IOException {
        CommonPage commonPage = new CommonPage(driver);
        Organization_General_Information_page organization_general_information_page = new Organization_General_Information_page(driver);
        Organization_Locations_page organization_locations_page=new Organization_Locations_page(driver);

        commonActionsProduced(url, username, password);
        commonPage.selectSectionOfAdmin(module_name1, sub_module_name1_of_module_name1,section2 );
        organization_general_information_page.verifySectionPage(section2);
